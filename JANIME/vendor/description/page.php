<?php
    ...
    $anime_name = $_GET['name'];
    $animes = mysqli_query($link, "SELECT * FROM `anime` WHERE `name` = '$anime_name'");
?>
...
<head>
    ...
    <script src="../../assets/js/main_anime.js"></script>
...
<body>
    ...
    <header>
            ...
            <div class="mn">
                ...
                <nav class="menu">
                    <ul>
                        <li><a href="../genres/1.php">Исекай</a></li>
                        <li><a href="../genres/2.php">Сёнен</a></li>
                        <li><a href="../genres/3.php">Фэнтези</a></li>
                        <li><a href="../genres/4.php">Комедия</a></li>
                        <li><a href="../genres/5.php">Меха</a></li>
                        <li><a href="../genres/6.php">Повседневность</a></li>
                        <li><a href="../genres/7.php">Приключения</a></li>
                        <li><a href="../genres/8.php">Спорт</a></li>
                    </ul>
                </nav>
            </div>
    ...
    <div class="foto">
        <div class="foto_div">
            <span class="foto_left"></span>
            <span class="foto_right"></span>
            <img class="image-1-1" src="../../<?php echo $anime['picture_1']?>" alt="#">
            <img class="image-2-1" src="../../<?php echo $anime['picture_2']?>" alt="#">
            <img class="image-3-1" src="../../<?php echo $anime['picture_3']?>" alt="#">
        </div>
    </div>
    ...
    <div class="content">
        ...
        <div id="c1">
            ...
            <ul class="ops">
                <li class="ds">Описание:</li>
                <li><?php echo $anime['description']?></li>
            </ul>
            
            <div class="image">
                <img class="image-1" src="../../<?php echo $anime['picture_1']?>" alt="#">
                <img class="image-2" src="../../<?php echo $anime['picture_2']?>" alt="#">
                <img class="image-3" src="../../<?php echo $anime['picture_3']?>" alt="#">
            </div>

            <video controls poster="../../<?php echo $anime['screen_splash']?>" class="video">
    ...
    <footer>
        ...
        <div class="logo-img2">
            <a href="../../index.php">
                <img class="logo2" src="../image/лого-2.png" alt="#">
            </a>
        </div>
