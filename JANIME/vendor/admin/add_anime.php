...
<body>
    ...
    <div class="content">
        ...
        <form class="content-editing" action="../components/add.php" method="post" enctype="multipart/form-data">
            <div class="info">   
                <div class="info-icon">+
                    <input type="file" name="anime_icon" class="info-icon-image" accept=".jpg, .png, .jpeg" required>
                </div>

                <ul class="info-head">
                    <li>Название аниме:<input type="text" name="name_anime"></li>
                    <li>Обозначение<input type="text" name="initials"></li>
                    <li>Жанры:<input type="text" name="genres"></li>
                    <li>Количество серий<input type="number" name="num_of_epis"></li>
                    <li>Длительность серии:<input type="text" name="duration"></li>
                    <li>Год выпуска:<input type="text" name="year"></li>
                    <li>Режиссер:<input type="text" name="director"></li>
                    <li>Студия:<input type="text" name="studio"></li>
                </ul>             
            </div>

            <div class="info-description">
                <h1>Описание</h1>
                <textarea class="info-description-text" name="description"></textarea>
            </div>
            ...
            <div class="info-gallery-section">
                ...
                <div class="gallery-images-section"></div>
            </div>

            <div class="info-video-section">

                <div class="info-video-icon">Заставка видео
                ...
                <div class="info-video">
                    ...
                    <video controls class="video-video"></video>

                </div>

            </div>

            <input type="submit" class="save" value="Сохранить" name="save">
